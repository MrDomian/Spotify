...
function Sidebar() {
    ...
    console.log(session);
    return (
        <div className="text-gray-500 p-5 text-x lg:text-sm border-r border-gray-900 overflow-y-scroll scrollbar-hide h-screen sm:max-w-[12rem] lg:max-w-[15rem] pb-24">
